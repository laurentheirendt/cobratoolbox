...
if [ "$ARCH" == "Linux" ]; then
    ...
    nohup "C:\Program Files\Matlab\R2016b\bin\matlab.exe" -useStartupFolderPref -logfile output.log -wait -r "restoredefaultpath; matlabrc; getenv('USERPROFILE'); initCobraToolbox;" & #cd test; testAll;
